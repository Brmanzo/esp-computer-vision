...
// 30fps@24MHz
const sensor_reg ov2640_settings_cif[] = {
    {BANK_SEL, BANK_DSP},
    {0x2c, 0xff},
    {0x2e, 0xdf},
...
const sensor_reg ov2640_settings_jpeg3[] = {
    {BANK_SEL, BANK_DSP},
    {RESET, RESET_JPEG | RESET_DVP},
...
const sensor_reg ov2640_settings_yuv422[] = {
    {BANK_SEL, BANK_DSP},
    {RESET, RESET_DVP},
...
const sensor_reg ov2640_settings_rgb565[] = {
    {BANK_SEL, BANK_DSP},
    {RESET, RESET_DVP},
