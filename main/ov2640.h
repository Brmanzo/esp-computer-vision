...
// This is the known-good, comprehensive register list for YUV QVGA
const struct sensor_reg ov2640_yuv_qvga_init_regs[] = {
	{0xFF, 0x01}, {0x12, 0x80}, {0xFF, 0x00}, {0xDA, 0x00},
	{0xD7, 0x03}, {0xE1, 0x77}, {0xE5, 0x1F}, {0x80, 0x5F},
	{0x81, 0x50}, {0x82, 0x22}, {0x83, 0x70}, {0x84, 0xAC},
	{0x85, 0xC8}, {0x86, 0xE1}, {0x87, 0xF0}, {0x88, 0x12},
	{0x89, 0x91}, {0x8A, 0xAB}, {0x8B, 0xCA}, {0x8C, 0xE5},
	{0x8D, 0x11}, {0x90, 0x05}, {0x91, 0x01}, {0x92, 0x05},
	{0x9D, 0x99}, {0x9E, 0x02}, {0xC0, 0xC8}, {0xC1, 0x96},
	{0xC2, 0x00}, {0xC3, 0x00}, {0x05, 0x01}, {0xD3, 0x82},
	{0xFF, 0x01}, {0x13, 0xE5}, {0x00, 0x00}, {0x10, 0x00},
	{0x0D, 0x41}, {0x14, 0x38}, {0x4F, 0xB3}, {0x50, 0xB3},
	{0x51, 0x00}, {0x52, 0x2D}, {0x53, 0xA7}, {0x54, 0xE4},
	{0x58, 0x9E}, {0xFF, 0x00}, {0x5A, 0x28}, {0x5B, 0x20},
	{0xFF, 0x01}, {0x17, 0x11}, {0x18, 0x65}, {0x19, 0x02},
	{0x1A, 0x7A}, {0x03, 0x0A}, {0x32, 0x36}, {0x11, 0x80},
	{0x04, 0x00}, {0x40, 0xC0}, {0xFF, 0xFF},
};
