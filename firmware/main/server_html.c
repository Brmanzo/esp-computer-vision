...
"\n"
"    var pixelIndex = 0;\n"
"    for(var i = 0; i < payloadLen - 2 && pixelIndex < pixels; i++){\n"
...
"\n"
"    var decisionByte = view[DATA_START + payloadLen - 2];\n"
"    var thresholdByte = view[DATA_START + payloadLen - 1];\n"
"    var gesture = GESTURES[decisionByte];\n"
"    var threshStr = '<br><span style=\"font-size: 14px; opacity: 0.7;\">Threshold: ' + thresholdByte + '</span>';\n"
"    if (gesture) {\n"
"      decisionEl.innerHTML = '<span style=\"font-size: 28px; margin-right: 8px;\">' + gesture.icon + '</span>' + gesture.name + threshStr;\n"
...
"    } else {\n"
"      decisionEl.innerHTML = 'Unknown (' + decisionByte + ') ❓' + threshStr;\n"
