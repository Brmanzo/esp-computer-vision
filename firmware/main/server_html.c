...
"  var DATA_START = 10;\n"
"  var GESTURES = [\n"
"    { name: \"Call Me\", icon: \"🤙\", color: \"#38bdf8\" },\n"
"    { name: \"Fingers Crossed\", icon: \"🤞\", color: \"#fb7185\" },\n"
"    { name: \"Okay\", icon: \"👌\", color: \"#34d399\" },\n"
"    { name: \"Paper\", icon: \"✋\", color: \"#facc15\" },\n"
"    { name: \"Peace\", icon: \"✌️\", color: \"#a78bfa\" },\n"
"    { name: \"Rock\", icon: \"✊\", color: \"#f87171\" },\n"
"    { name: \"Rock On\", icon: \"🤘\", color: \"#f472b6\" },\n"
"    { name: \"Scissor\", icon: \"✌️\", color: \"#fb923c\" }\n"
"  ];\n"
