...
def test_each(test_name, simulator):
    ...
    runner(simulator, timescale, tbpath, parameters, testname=test_name, pymodule="test_rle_encode")
...
def test_all(simulator):
    ...
    parameters = dict(locals())
    del parameters['simulator']
    runner(simulator, timescale, tbpath, parameters, pymodule="test_rle_encode")
...
def test_lint(simulator):
    ...
    parameters = dict(locals())
    del parameters['simulator']
    lint(simulator, timescale, tbpath, parameters, pymodule="test_rle_encode")
...
def test_style(simulator):
    ...
    parameters = dict(locals())
    del parameters['simulator']
    lint(simulator, timescale, tbpath, parameters, compile_args=["--lint-only", "-Wwarn-style", "-Wno-lint"], pymodule="test_rle_encode")
