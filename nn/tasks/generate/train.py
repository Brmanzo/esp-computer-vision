...
from nn.globals   import CLK_FREQ_HZ
from nn.inference import get_inference_from_pixels
from nn.tasks.generate.generate import NUM_CLASSES, generate_networks, _fmt, IMG_W, IMG_H
...
RESULTS_PATH = Path("nn") / "tasks" / "generate" / "results.txt"
...
def sweep(
    ...
    train_loader, test_loader, _ = prepare_mnist_data(DATA_DIR, IMG_H, IMG_W, BATCH_SIZE)
    ...
    _, hw_test_loader, _         = prepare_mnist_data(DATA_DIR, IMG_H, IMG_W, batch_size=1)
