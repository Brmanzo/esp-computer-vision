...
from nn.globals import LC_CAP, CLK_FREQ_HZ
from nn.tasks.generate.generate import IMG_W, IMG_H

RESULTS_PATH  = Path("nn") / "tasks" / "generate" / "results.txt"
PLOT_HTML     = Path("nn") / "tasks" / "generate" / "networks_plot.html"
ACCURACY_HTML = Path("nn") / "tasks" / "generate" / "accuracy_plot.html"
BITS_HTML     = Path("nn") / "tasks" / "generate" / "bits_plot.html"
