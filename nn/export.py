...
from nn.globals  import DATAPATH, ROMPATH, MNIST_CFG
...
if __name__ == "__main__":
    ...
    parser.add_argument("network_in", nargs="?", default=DATAPATH / "mnist_net_quantized.pth", type=Path)
    ...
    export_nn_to_csv(args.network_in, config=MNIST_CFG, output_csv=args.csv_out, random_weights=args.random)

    # 2. Generate the SystemVerilog header and hex files
    export_csv_to_hex(args.csv_out, args.sv_out, args.hex_out, config=MNIST_CFG)
